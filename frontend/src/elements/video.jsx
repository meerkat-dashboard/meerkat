...
export function IframeVideo({options}, props) {
	...
	return (
		<div class="video-overlay">
			<div data-vjs-player>
				<video-js onClick={noDefaultBehavior} ref={playerRef} id='livestream' style="pointer-events: none" className="video-js vjs-16-9 vjs-big-play-centered video-player" playsInline>
